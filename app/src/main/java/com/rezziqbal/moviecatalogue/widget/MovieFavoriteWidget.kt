...
class MovieFavoriteWidget : AppWidgetProvider() {
    companion object {
        ...
        internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            val intent = Intent(context, MovieStackService::class.java)
            ...
            val actionIntent = Intent(context, MovieFavoriteWidget::class.java)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null && intent.action == KEY_ACTION) {
            val movie: Movie? = intent.getParcelableExtra(EXTRA_ITEM)
            movie?.let { openMovieDetail(context, it) }
        } else {
            Log.d("test", "test")
        }
    ...
    private fun updateWidgetComponent(context: Context) {
        ...
        val componentName = ComponentName(context, MovieFavoriteWidget::class.java)
    ...
    private fun openMovieDetail(context: Context, movie: Movie) {
